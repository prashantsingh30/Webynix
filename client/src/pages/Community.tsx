            ...
            <div className='px-4 md:px-16 lg:px-24 xl:px-32'>
                {loading ? (
                    ...
                    <div className='py-10 min-h-[80vh]'>
                        ...
                        <div className='flex flex-wrap gap-3.5'>
                            {projects.map((project) => (
                                <Link to={`/view/${project.id}`} key={project.id} target='_blank' className='w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden hover:border-indigo-800/80 transition-all duration-300'>
                                    ...
                                    <div className='p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors'>
                                        ...
                                        <p className='text-sm text-gray-400 line-clamp-2 mt-1'>{project.initial_prompt}</p>
                    ...
                    <div className='flex flex-col items-center justify-center h-[80vh]'>
                        <h1 className='text-3xl font-semibold text-gray-300'>You haven't created any projects yet.</h1>
                        <button onClick={() => navigate('/')} className='text-white px-5 py-2 mt-5 bg-indigo-500 hover:bg-indigo-600 active:scale-95 transition-all rounded-md'>
                            Create New
                        </button>
                    </div>
                )}
