...
const Navbar = () => {
    ...
    return (
        <>
            ...
            {/* BACKGROUND IMAGE */}
            <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/refs/heads/main/assets/hero/bg-gradient-2.png" className="fixed inset-0 -z-10 w-full h-full object-cover opacity-100 pointer-events-none" alt="" />
